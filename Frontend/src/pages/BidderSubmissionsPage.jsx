    ...
    <div className="flex flex-col h-full">
            ...
            {isDraft && (
              <div className="bg-amber-50 border border-amber-300 rounded-lg p-4">
                ...
                <button
                  ...
                  className="px-4 py-2 bg-blue-700 hover:bg-blue-800 text-white rounded text-xs font-bold cursor-pointer transition-colors"
                >
                  Complete Submission
                </button>
              </div>
      ...
      <div className="p-4 border-t border-slate-200 bg-white shrink-0 flex flex-wrap items-center justify-between gap-2">
        ...
        <button
          ...
          className="px-5 py-2 bg-blue-700 hover:bg-blue-800 text-white rounded-full text-xs font-bold cursor-pointer transition-all flex items-center gap-2 shadow-2xs"
        >
