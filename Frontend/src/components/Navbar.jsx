      ...
      <div className="h-14 px-4 md:px-6 flex items-center justify-between">
        <div className="flex items-center gap-3">
          ...
          <div className="hidden sm:flex items-center gap-2">
            <span className="px-2 py-0.5 bg-slate-100 text-slate-800 text-[10px] font-extrabold uppercase tracking-wider rounded border border-slate-200">
              ProcuraAI Engine
            </span>
            <span className="text-slate-300">|</span>
            <span className="text-xs font-bold text-slate-700">
              {isOfficer ? 'Public Procurement Officer Interface' : 'Authorized Vendor Portal'}
            </span>
          </div>
          ...
          <div className="relative hidden xl:block w-72 ml-4">
            <input
              ...
              className="w-full pl-8 pr-3 py-1 bg-slate-50 border border-slate-300 rounded text-xs text-slate-900 placeholder-slate-400 focus:outline-none focus:ring-1 focus:ring-slate-700 focus:bg-white"
            />
            <svg
        ...
        <div className="flex items-center gap-3">
          ...
          <div className="relative">
            <button
              ...
              className="p-1.5 rounded text-slate-600 hover:bg-slate-100 relative cursor-pointer flex items-center gap-1 text-xs font-semibold"
            >
          ...
          <div className="flex items-center gap-2 pl-3 border-l border-slate-200">
            <div className="w-7 h-7 rounded bg-slate-900 text-white font-bold flex items-center justify-center text-xs border border-slate-800">
              {user.avatar}
            </div>
            <div className="hidden lg:block text-left text-xs">
              <p className="font-extrabold text-slate-900 leading-tight">{user.name}</p>
              <p className="text-[10px] text-slate-500 font-semibold leading-tight">{user.role}</p>
            </div>
          </div>
        </div>
      </div>
